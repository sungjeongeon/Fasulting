...
CREATE TABLE `reservation_cal` (
	...
	`day_of_week`	BIGINT	NOT NULL	COMMENT '1 : 월
2 : 화
3 : 수
4 : 목
5 : 금
...
6 : 토
7 : 일',
	`hour`	BIGINT	NOT NULL	COMMENT '0 ~ 24 시간, 30분 단위 1 ~ 48'
);
...
6 : 토
7 : 일',
	`am_start`	BIGINT	NOT NULL	COMMENT '1 ~ 48 로 표현(0시부터 24시까지 30분 단위)',
	`am_end`	BIGINT	NOT NULL	COMMENT '1 ~ 48 로 표현(0시부터 24시까지 30분 단위)',
	`pm_start`	BIGINT	NOT NULL	COMMENT '1 ~ 48 로 표현(0시부터 24시까지 30분 단위)',
	`pm_end`	BIGINT	NOT NULL	COMMENT '1 ~ 48 로 표현(0시부터 24시까지 30분 단위)',
