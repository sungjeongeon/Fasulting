...
function HospitalReservation() {
  ...
  const modalClose = () => {dispatch(modalStateChange())}
      ...
      <div className={styles.modalbox}>
        <div className={styles.flexcol}>
          ...
          <div className={`${styles.flexrow} ${styles.mt}`}>
            ...
            <span className={styles.span}>{`${hour.toString().length < 2 ? twolen(hour) : hour}시 ${minute}분`}</span>
          </div>
          ...
          { afterReserveTime > new Date() ?
            ...
            <div className={styles.flexcol}>
              <div className={styles.flex}>
                <button
                  className={`${styles.okay} ${styles.mr}`}
                >
                  이미지 다운로드
                </button>
                <button className={styles.okay}>
                  상담 입장
                </button>
              </div>
            </div>
